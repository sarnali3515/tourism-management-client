    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center  mt-10">
                <h1 className="text-xl md:text-4xl font-bold my-8 text-center">Wonder Spots</h1>
            ...
            <div>
                <div className="text-center space-y-3 my-10">
                    <h1 className="text-xl md:text-3xl font-bold my-8 text-center">Explore All the Countries</h1>
