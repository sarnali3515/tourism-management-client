    ...
    return (
        <div className="lg:p-5">
            <div className="hero rounded-lg" style={{ backgroundImage: 'url(https://i.ibb.co/ydpGCgJ/andrew-coelho-m6t-Aq-Zvy4-RM-unsplash.jpg)' }}>
                ...
                <div className="hero-content lg:w-4/5 text-center">
                    <div className="w-full">
                        <div className="flex flex-col-reverse lg:flex-row w-full rounded-lg shadow-2xl bg-cyan-50">
                            ...
                            <div>
                                <h1 className="text-center font-bold text-xl md:text-4xl pt-2">Welcome Back to Travel Trails <br />Login to Explore</h1>
